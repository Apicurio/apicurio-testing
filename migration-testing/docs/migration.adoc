...
* {registry} 3.x maintains backward compatibility with v2 client libraries and SerDes. Continue using v2 clients with a v3 registry during your migration period, allowing gradual client updates.
