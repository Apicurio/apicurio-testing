...
[role="_abstract"]
This documentation provides comprehensive guidance for migrating from {registry} {registry-v2} to {registry} 3.x.
...
The migration approach you choose determines the amount of downtime your registry experiences:
