...
* Update client applications to point to {registry} 3.x. Perform this step after the data migration completes. See xref:migrating-registry-applications_{context}[Migrating {registry} client applications].
