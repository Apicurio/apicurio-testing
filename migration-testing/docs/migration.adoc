...
. Export data from {registry} {registry-v2}. See xref:migrating-registry-data_{context}[Migrating registry data].
...
. Import data into {registry} 3.x. See xref:migrating-registry-data_{context}[Migrating registry data].
