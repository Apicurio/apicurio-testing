...
== Understanding changes in {registry} 3.x
...
For the metrics capture procedure, see xref:migration-scripts_{context}[Using migration scripts].
...
NOTE: The import adds to existing data (does not replace). Import into an empty v3 registry for best results.
...
For the verification procedure, see xref:migration-scripts_{context}[Using migration scripts].
...
For the v3 API verification procedure, see xref:migration-scripts_{context}[Using migration scripts].
...
. Export data from {registry} {registry-v2} using the export script. See xref:migration-scripts_{context}[Using migration scripts].
...
. Import data into {registry} 3.x using the import script. See xref:migration-scripts_{context}[Using migration scripts].
. Validate the import using the verification scripts. See xref:migration-scripts_{context}[Using migration scripts].
